...
<Note>
 the current MarkApiDown release executes only the single `## Expected response` block. Error responses are reference examples for humans, the web preview source view, and AI agents.
</Note>
