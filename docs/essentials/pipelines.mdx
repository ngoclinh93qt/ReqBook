---
title: "API Flow Testing Pipelines"
description: "Chain markdown endpoint specs into executable API flows that capture response values and inject them into later steps."
icon: "code-branch"
---
