...
| `version` | yes | integer | MarkApiDown spec format version. Must be `1` for v1.0.0. |
...
MarkApiDown v1.0.0 does not execute plugins. The `## Plugins` section is reserved for future use. Keep it as an empty list or omit the section entirely.
